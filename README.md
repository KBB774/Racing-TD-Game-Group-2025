...
Our Team!
- __Kellen Brim__ (Team Lead / Main GUI Artist and Formatting)
- __Zac Hawkins__ (Scheduling Coordinator)
- __Mark Connell__ (Planning)
- __Henry Griffin__ (Main Artist)
...
![Logo Mockup](https://github.com/KBB774/Racing-TD-Game-Group-2025/blob/main/images/StartScreen.png?raw=true)
